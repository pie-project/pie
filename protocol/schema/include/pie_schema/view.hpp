// pie_schema/view.hpp — driver-side SoA view + AoS→SoA demux.
//
// Compatibility adapter for the C++ backends (cuda + portable). The
// wire schema in pie_schema.h gives you `Pie*Desc` POD structs that
...
#include <pie_schema.h>  // PieFrameDesc, PieResponseFrameDesc, PIE_*
