...
use pie_sampling_ir::ptir::container::{decode, encode};
use pie_sampling_ir::ptir::container_hash;
use pie_sampling_ir::ptir::interp::{Instance, NoKernels, PassInputs};
use pie_sampling_ir::ptir::registry::{ModelProfile, Port};
use pie_sampling_ir::ptir::validate::bind;
...
fn section3_end_to_end_with_late_mask_and_recovery() {
    ...
    assert_eq!(inst.host_read(&b, 1), Err(pie_sampling_ir::ptir::interp::HostError::WouldBlock));
