...
//!
//! Identity = [`crate::ptir::container_hash`] (FNV-1a 64) over these canonical
...
use crate::{ptir::PTIR_MAGIC, ptir::PTIR_VERSION};
...
pub fn decode(bytes: &[u8]) -> Result<TraceContainer, ContainerDecodeError> {
    ...
    Ok(TraceContainer { names, channels, ports, stages })
}
