...
pub const LANE_TABLE_ABI_VERSION: u32 = 2;
...
fn match_nucleus_add_order(
    ...
    if [logits, top_p, rng_state].into_iter().any(|input| {
        producer
            .get(input as usize)
    ...
    Some(LibraryMatch {
        ...
        nodes: ordered_nodes,
        inputs: vec![logits, top_p, rng_state],
        outputs: vec![token],
    })
}
...
mod tests {
    ...
    fn lane_layout_is_stable() {
        ...
        assert_eq!(core::mem::size_of::<LaneRecord>(), 72);
