//! A hand-written component that exercises stdout, the monotonic clock, random
//! bytes and a timer through the wasi-web host.
...
/// The guest: writes a line to stdout, sleeps 1ms via `subscribe-duration` +
/// `poll`, reads the clock twice and asserts it moved, and pulls 8 random bytes.
const GUEST: &str = r#"
(component
