...
pub fn full(
    ...
    ctx.fire(
        OP,
        Fire::at(FILE, "::pie::rope::rotate<::pie::false_type::value, false>").apply(
            rotate_launch(q.rows, num_q_heads + num_kv_heads, per_block, pairs * 2 * 4),
        ),
...
pub fn partial_last(
    ...
    ctx.fire(
        OP,
        Fire::at(FILE, "::pie::rope::rotate_partial_last")
...
pub fn yarn(
    ...
    ctx.fire(
        OP,
        Fire::at(FILE, "::pie::rope::rotate_yarn_original").apply(rotate_launch(
            q.rows,
...
fn rope_partial(
    ...
    ctx.fire(
        op,
        Fire::at(FILE, "::pie::rope::rotate_partial<::pie::bf16>")
            .apply(Launch::per_row(q.rows, ROTATE_BLOCK)),
        &[
            q.arg(),
            k.arg(),
