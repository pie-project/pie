//! A transcription of libstdc++'s introsort, kept for the same reason as
//! [`heap`](super::heap): the sm90 and mla schedulers sort requests by kv
//! length and the reference planner's tie order between equal lengths is
//! part of the schedule the device text was validated against.
