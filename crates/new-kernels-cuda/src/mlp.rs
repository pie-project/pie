...
pub fn swiglu(
    ...
    ctx.fire(
        OP,
        Fire::at(FILE, symbol(&format!("::pie::mlp::chunked_swiglu<{t}>"))).apply(launch),
...
pub fn swiglu_clamp(
    ...
    ctx.fire(
        ...
        Fire::at(
            FILE,
            symbol(&format!("::pie::mlp::chunked_swiglu_clamp<{t}>")),
        )
        .apply(launch),
...
pub fn swiglu_clamp_alpha(
    ...
    ctx.fire(
        ...
        Fire::at(
            FILE,
            symbol(&format!("::pie::mlp::chunked_gpt_oss_glu<{t}>")),
        )
        .apply(launch),
...
pub fn geglu_tanh(ctx: &Ctx, gate: Tensor, up: Tensor, y: &mut Tensor) -> Result<(), KernelError> {
    ...
    ctx.fire(
        OP,
        Fire::at(FILE, symbol(&format!("::pie::mlp::geglu_tanh<{t}>")))
...
pub fn geglu_tanh_packed(
    ...
    ctx.fire(
        ...
        Fire::at(
            FILE,
            symbol(&format!("::pie::mlp::chunked_geglu_tanh<{t}>")),
        )
        .apply(launch),
        &[packed.arg(), y.arg(), width.arg()],
    )
...
pub fn situ(
    ...
    ctx.fire(
        OP,
        Fire::at(FILE, symbol(&format!("::pie::mlp::chunked_situ<{t}>"))).apply(launch),
        &[
            packed.arg(),
            y.arg(),
            width.arg(),
