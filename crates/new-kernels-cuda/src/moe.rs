...
const DISPATCH_FILE: &str = "moe/moe_dispatch.cuh";
...
pub fn topk_softmax(
    ...
    ctx.fire(
        ...
        Fire::at(
            ...
            symbol(&format!("::pie::moe::topk_softmax<{t}>")),
        )
...
pub fn topk_sigmoid(
    ...
    ranked_router(
        ...
        symbol(&format!("::pie::moe::topk_sigmoid<{t}>")),
        logits,
        None,
        experts,
        top_k,
...
pub fn topk_sqrt_softplus(
    ...
    ranked_router(
        ...
        symbol(&format!("::pie::moe::topk_sqrtsoftplus<{t}>")),
        logits,
        Some(bias),
        experts,
        top_k,
...
pub fn matmul_select(
    ...
    ctx.fire(
        ...
        Fire::at(
            DISPATCH_FILE,
            symbol(&format!("::pie::moe::moe_decode_gemv_{form}<{t}>")),
        )
        .apply(Launch::grid(
...
pub fn matmul_select_bias(
    ...
    ctx.fire(
        ...
        Fire::at(
            ...
            symbol(&format!(
                "::pie::quant::mxfp4_matmul_select_bias<{t}, ::pie::i32({ROWS_PER_WARP})>"
            )),
        )
        .apply(Launch::grid(
...
pub fn weighted_sum(
    ...
    ctx.fire(
        ...
        Fire::at(
            DISPATCH_FILE,
            symbol(&format!("::pie::moe::token_batched_weighted_sum<{t}>")),
        )
...
pub fn sigmoid_gate_add(
    ...
    ctx.fire(
        ...
        Fire::at(
            "mlp/swiglu.cuh",
            symbol(&format!("::pie::mlp::sigmoid_scalar_gate_add<{t}>")),
        )
        .apply(elementwise_rows(OP, y.rows, y.width)?),
        &[
            y.arg(),
