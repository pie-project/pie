...
/// The units that do not take the defaults. The attn entries land in the
/// next wave; their rows stay so the configuration travels with the file
/// name, not with the wave that fires it.
