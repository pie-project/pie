...
// PIE: guarded for NVRTC -- the whole file. `MinHeap` is a `std::vector` of pairs used by
// the host scheduler to balance work across CTAs before a launch. It is host code end to
// end. Upstream is unmodified apart from markers of this form; see NOTICE. Removing them
// restores the file.
