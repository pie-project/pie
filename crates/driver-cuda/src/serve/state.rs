...
pub(crate) struct Shell {
    ...
    pub(crate) kv_format: crate::store::KvCacheFormat,
    ...
    /// is for.
    pub(crate) cublas:
        Option<crate::cuda::cublas::CublasHandle<cudarc::cublas::sys::cublasHandle_t>>,
    ...
    pub(crate) preds: Option<crate::cuda::PredicateWord>,
    ...
    pub(crate) peel_win: Option<crate::cuda::PeelWindowWord>,
    ...
    pub(crate) logits_staging: Option<crate::cuda::PinnedBuf>,
    ...
    /// convention.
    pub(crate) supergraph: crate::model::supergraph::SupergraphCache,
    ...
    pub(crate) fire_arrays: FireArrays,
    ...
    pub(crate) fire_stream: Option<crate::cuda::OwnedStream>,
    ...
    pub(crate) fire_alloc: Option<crate::cuda::Allocator>,
    ...
    pub(crate) ptir: crate::ptir::Runtime,
    /// The compiled form of each registered program, by program id.
    pub(crate) ptir_programs: crate::ptir::Programs,
    ...
    pub(crate) ptir_control: Option<crate::ptir::Control>,
    ...
    pub(crate) ptir_sessions: std::collections::BTreeMap<u64, crate::ptir::session::Session>,
...
pub(crate) struct FireScratch {
    pub(crate) ws: crate::model::attention_workspace::AttentionWorkspace<
    ...
    pub(crate) prefill_ws: crate::model::attention_workspace::AttentionWorkspace<
        cudarc::runtime::sys::cudaEvent_t,
    >,
    pub(crate) decode_plan: crate::model::executor::DecodePlan,
    /// gemma-4's SECOND decode plan — the FULL layers' 512-wide
    /// geometry; single-kind families never plan it.
    pub(crate) decode_plan_full: crate::model::executor::DecodePlan,
    pub(crate) prefill_plan: crate::model::executor::PrefillPlan,
}
...
pub(crate) struct SwapPool {
    ...
    /// a constant. `store::swap_pool::SwapPool` says what to allocate;
    ...
    /// serve.
    pub(crate) plan: crate::store::swap_pool::SwapPoolLayout,
    ...
    pub(crate) evict: Option<crate::cuda::OwnedStream>,
    pub(crate) restore: Option<crate::cuda::OwnedStream>,
}
...
impl ChannelState {
    ...
    /// that a cell is full.
    ///
    /// This driver allocates a `ptir::ring::Rings` PER SESSION and a
    ...
    pub(crate) fn shape(&self) -> crate::ptir::ring::ChannelShape {
...
pub(crate) struct InFlight {
    pub(crate) done: crate::cuda::Event,
    ...
    pub(crate) scratch: Vec<crate::cuda::DeviceBuffer>,
...
pub(crate) struct LoweredFire {
    ...
    pub(crate) dplan: crate::model::executor::DispatchPlan,
...
impl ChannelState {
    ...
    pub(crate) fn host_plane(&self) -> crate::ptir::bridge::HostChannel {
...
/// answer.
#[derive(Default)]
pub(crate) struct FireArrays {
    pub(crate) arena: Option<crate::cuda::DeviceBuffer>,
    /// The unconditional attention-score sink — see [`Self::score`].
    pub(crate) score: Option<crate::cuda::DeviceBuffer>,
    /// The unconditional custom attention mask — see [`Self::mask`].
    pub(crate) mask: Option<crate::cuda::DeviceBuffer>,
    /// The driver-owned attention landing buffer — see [`Self::attn_out`].
    pub(crate) attn_out: Option<crate::cuda::DeviceBuffer>,
    pub(crate) named:
        std::collections::BTreeMap<model_compiler::trace::ValueId, crate::cuda::DeviceBuffer>,
    /// The small per-fire u32 descriptor arrays, by slot.
    pub(crate) slots: Vec<Option<crate::cuda::DeviceBuffer>>,
    ...
    pub(crate) staging: Vec<Option<crate::cuda::PinnedBuf>>,
    pub(crate) epoch: u64,
}
...
pub(crate) struct KvState {
    pub(crate) cache:
        crate::store::kv_cache_live::KvCache<crate::store::kv_cache_live::AllResident>,
    /// Backing store for `cache`; dropping this frees the pages.
    pub(crate) _held: Vec<crate::cuda::DeviceBuffer>,
...
impl KvState {
    ...
    pub(crate) fn views(&self) -> Vec<crate::launch::KvCacheLayerView> {
        (0..self.layers())
...
/// [`RecurrentStateCache`](crate::store::recurrent_state_cache).
///
...
/// same three jobs `store::recurrent_state_cache` was ported to do, and
...
pub(crate) struct GdnState {
    ...
    pub(crate) cache: crate::store::recurrent_state_cache::RecurrentStateCache,
    /// The two pooled allocations, in `Buffer` order. `mtp` is absent
    /// until the MTP pending-hidden row has a writer.
    pub(crate) conv: crate::cuda::DeviceBuffer,
    pub(crate) recurrent: crate::cuda::DeviceBuffer,
...
impl GdnState {
    ...
    pub(crate) fn apply(
        &self,
        ops: &[crate::store::recurrent_state_cache::StateOp],
        stream: crate::cuda::StreamRef<'_>,
    ) -> Result<(), i32> {
        use crate::store::recurrent_state_cache::{Buffer, StateOp};
    ...
    pub(crate) fn ensure_slots(
        ...
        let grown = crate::store::recurrent_state_cache::RecurrentStateCache::allocate_bf16_recurrent(
            &self.is_linear,
            self.cache.conv_dim(),
        ...
        let mut conv = alloc.alloc(conv_n).map_err(|_| PIE_STATUS_EXHAUSTED)?;
        let mut recurrent = alloc.alloc(rec_n).map_err(|_| PIE_STATUS_EXHAUSTED)?;
        conv.memset(0, stream.as_ref()).map_err(|_| PIE_STATUS_DRIVER_ERROR)?;
        recurrent.memset(0, stream.as_ref()).map_err(|_| PIE_STATUS_DRIVER_ERROR)?;
        {
...
pub(crate) struct LoadedModel {
    pub(crate) hf: crate::model::config::HfConfig,
    ...
    /// `cudaMalloc`s.
    pub(crate) weights: std::collections::BTreeMap<String, crate::loader::stage::WeightSpan>,
    /// The arena, and anything the plan published outside it. Held so the
    /// spans above stay valid; never indexed.
    #[allow(dead_code)]
    pub(crate) owned: Vec<crate::cuda::DeviceBuffer>,
...
impl LoadedModel {
    ...
    ///
    /// Five references, built per call. It exists so that `crate::facts`
    ...
    pub(crate) fn checkpoint(&self) -> crate::facts::Checkpoint<'_> {
        crate::facts::Checkpoint {
            hf: &self.hf,
            tensors: self,
...
///
/// Both are plain map reads; they are a trait because `crate::facts` must
/// not name `crate::loader`'s types — see that module's doc for why.
impl crate::facts::Tensors for LoadedModel {
