...
#[cfg(feature = "bridge")]
impl crate::gpu::fire::sideband_arena::DeviceMemory for LiveLoraOps {
...
impl LoraOps for LiveLoraOps {
    ...
    fn cast_fp32_to_bf16(&mut self, src: *const c_void, dst: *mut c_void, elems: usize) {
        unsafe {
            crate::gpu::bind::abi::ffi::pie_k_quant_cast_fp32_to_bf16(src, dst, elems, self.stream);
        }
    }
...
/// [`crate::gpu::fire::launch::attention_pins`] reads attention's, and
...
pub fn lane_for_instance(
    ...
    sessions: &std::collections::BTreeMap<u64, crate::gpu::program::session::Session>,
    instances: &std::collections::BTreeMap<u64, crate::gpu::serve::state::InstanceEntry>,
    instance_id: u64,
    token_start: u32,
    token_count: u32,
    ...
    let stage = compiled.stage_of_kind(crate::gpu::program::runtime::stage_kind::PROLOGUE)?;
