...
use crate::gpu::fire::scratch::Scratch;
...
pub(crate) struct Shell {
    ...
    /// is for.
    pub(crate) cublas:
        Option<crate::gpu::device::cublas::CublasHandle<cudarc::cublas::sys::cublasHandle_t>>,
    ...
    pub(crate) preds: Option<crate::gpu::device::PredicateWord>,
    ...
    pub(crate) peel_win: Option<crate::gpu::device::PeelWindowWord>,
    ...
    pub(crate) logits_staging: Option<crate::gpu::device::PinnedBuf>,
    ...
    /// convention.
    pub(crate) supergraph: crate::gpu::fire::recordings::Recordings,
    ...
    pub(crate) lora_arena: crate::gpu::fire::lora::LoraStageArena,
    ...
    pub(crate) fire_stream: Option<crate::gpu::device::OwnedStream>,
    ...
    pub(crate) fire_alloc: Option<crate::gpu::device::Allocator>,
    ...
    /// [`crate::gpu::program::Runtime`] is the CACHE — it outlives any one program
    ...
    pub(crate) ptir: crate::gpu::program::Runtime,
    /// The compiled form of each registered program, by program id.
    pub(crate) ptir_programs: crate::gpu::program::Programs,
    ...
    pub(crate) ptir_control: Option<crate::gpu::program::Control>,
    ...
    pub(crate) ptir_sessions: std::collections::BTreeMap<u64, crate::gpu::program::session::Session>,
...
pub(crate) struct FireScratch {
    pub(crate) ws: crate::gpu::fire::attention_workspace::AttentionWorkspace<
    ...
    pub(crate) prefill_ws: crate::gpu::fire::attention_workspace::AttentionWorkspace<
        cudarc::runtime::sys::cudaEvent_t,
    >,
    pub(crate) decode_plan: crate::gpu::bind::DecodePlan,
    /// gemma-4's SECOND decode plan — the FULL layers' 512-wide
    /// geometry; single-kind families never plan it.
    pub(crate) decode_plan_full: crate::gpu::bind::DecodePlan,
    pub(crate) prefill_plan: crate::gpu::bind::PrefillPlan,
}
...
pub(crate) struct SwapPool {
    ...
    /// a constant. `gpu::pools::swap_pool::SwapPool` says what to allocate;
    ...
    /// serve.
    pub(crate) plan: crate::gpu::pools::swap_pool::SwapPoolLayout,
    ...
    pub(crate) evict: Option<crate::gpu::device::OwnedStream>,
    pub(crate) restore: Option<crate::gpu::device::OwnedStream>,
}
...
impl ChannelState {
    ...
    pub(crate) fn shape(&self) -> crate::gpu::program::channel::ChannelShape {
        crate::gpu::program::channel::ChannelShape {
            numel: self.numel,
            dtype: self.dtype,
...
pub(crate) struct InFlight {
    pub(crate) done: crate::gpu::device::Event,
    ...
    pub(crate) scratch: Vec<crate::gpu::device::DeviceBuffer>,
...
pub(crate) struct LoweredFire {
    ...
    pub(crate) dplan: crate::gpu::bind::DispatchPlan,
...
impl ChannelState {
    ...
    pub(crate) fn host_plane(&self) -> crate::gpu::program::channel::HostChannel {
        debug_assert!(self.cell_bytes * self.ring as usize <= self.mirror_bytes);
        unsafe {
            crate::gpu::program::channel::HostChannel::new(
                self.mirror,
                self.words,
                self.cell_bytes,
                self.ring,
...
///
/// The geometry is [`gpu::pools::kv_cache_live::KvCache`](crate::gpu::pools::kv_cache_live::KvCache)'s:
...
pub(crate) struct KvState {
    pub(crate) cache:
        crate::gpu::pools::kv_cache_live::KvCache<crate::gpu::pools::kv_cache_live::AllResident>,
    /// Backing store for `cache`; dropping this frees the pages.
    pub(crate) _held: Vec<crate::gpu::device::DeviceBuffer>,
...
impl KvState {
    ...
    pub(crate) fn views(&self) -> Vec<crate::gpu::bind::abi::KvCacheLayerView> {
        (0..self.layers())
...
/// [`RecurrentStateCache`](crate::gpu::pools::recurrent_state_cache).
///
...
/// same three jobs `gpu::pools::recurrent_state_cache` was ported to do, and
...
pub(crate) struct GdnState {
    ...
    pub(crate) cache: crate::gpu::pools::recurrent_state_cache::RecurrentStateCache,
    /// The two pooled allocations, in `Buffer` order. `mtp` is absent
    /// until the MTP pending-hidden row has a writer.
    pub(crate) conv: crate::gpu::device::DeviceBuffer,
    pub(crate) recurrent: crate::gpu::device::DeviceBuffer,
...
impl GdnState {
    ...
    pub(crate) fn apply(
        &self,
        ops: &[crate::gpu::pools::recurrent_state_cache::StateOp],
        stream: crate::gpu::device::StreamRef<'_>,
    ) -> Result<(), i32> {
        use crate::gpu::pools::recurrent_state_cache::{Buffer, StateOp};
    ...
    pub(crate) fn ensure_slots(
        ...
        let grown = crate::gpu::pools::recurrent_state_cache::RecurrentStateCache::allocate_bf16_recurrent(
            &self.is_linear,
            self.cache.conv_dim(),
...
pub(crate) fn install_kv(kv: &mut Option<KvState>, epoch: &mut u64, next: KvState) {
    *kv = Some(next);
    *epoch += 1;
}
...
pub(crate) struct LoadedModel {
    ...
    /// `cudaMalloc`s.
    pub(crate) weights: std::collections::BTreeMap<String, crate::gpu::weights::stage::WeightSpan>,
    /// The arena, and anything the plan published outside it. Held so the
    /// spans above stay valid; never indexed.
    #[allow(dead_code)]
    pub(crate) owned: Vec<crate::gpu::device::DeviceBuffer>,
...
) -> Option<Vec<crate::gpu::program::channel::ChannelShape>> {
    instance
        .channel_ids
        .iter()
