...
/// [`Allocator`](crate::gpu::device::Allocator), which is already outside the
...
/// gone. So the ops object keeps the [`DeviceBuffer`](crate::gpu::device::DeviceBuffer)s
...
pub struct LiveKvCacheOps<'a> {
    stream: *mut c_void,
    alloc: &'a crate::gpu::device::Allocator,
    held: Vec<crate::gpu::device::DeviceBuffer>,
}
...
impl<'a> LiveKvCacheOps<'a> {
    ...
    ///
    /// `alloc` is borrowed, not held: [`Allocator`](crate::gpu::device::Allocator)
    ...
    #[must_use]
    pub const fn new(stream: *mut c_void, alloc: &'a crate::gpu::device::Allocator) -> Self {
    ...
    pub fn held_bytes(&self) -> usize {
        self.held.iter().map(crate::gpu::device::DeviceBuffer::len).sum()
    }
    ...
    #[must_use]
    pub fn into_held(self) -> Vec<crate::gpu::device::DeviceBuffer> {
        self.held
    }
}
...
impl KvCacheDeviceOps for LiveKvCacheOps<'_> {
    ...
    fn envelope_seed(
        ...
        unsafe {
            crate::gpu::bind::abi::ffi::pie_k_layout_launch_envelope_seed_empty_bf16(
                env_min,
                env_max,
                num_pages,
                num_kv_heads,
...
///
/// [`ElasticPool`] has no other implementor: [`Arena`](crate::gpu::device::vmm::Arena)
...
impl<E: ElasticPool> KvCache<E> {
    ...
    /// table entries).
    #[must_use]
    pub fn layer_view(&self, layer: i32) -> crate::gpu::bind::abi::KvCacheLayerView {
        ...
        crate::gpu::bind::abi::KvCacheLayerView {
            layer,
            source_layer: src,
...
fn scheme_for_launch(f: &KvCacheFormat) -> crate::gpu::bind::abi::KvCacheScheme {
    use crate::layout::KvCacheScheme as S;
    match f.scheme() {
        S::Native => crate::gpu::bind::abi::KvCacheScheme::Native,
        S::Fp8PerTensor => crate::gpu::bind::abi::KvCacheScheme::Fp8PerTensor,
        S::Int8PerTokenHead => crate::gpu::bind::abi::KvCacheScheme::Int8PerTokenHead,
        S::Fp8PerTokenHead => crate::gpu::bind::abi::KvCacheScheme::Fp8PerTokenHead,
        S::Fp4Block => crate::gpu::bind::abi::KvCacheScheme::Fp4Block,
    }
}
