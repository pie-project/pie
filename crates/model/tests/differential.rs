...
//! `crates/driver-cuda/tests/hf_config_dump/` holds the C++ oracle's transcript (a JSON
...
fn oracle_dir() -> PathBuf {
    // The corpus MOVED to `driver-cuda` when the C++ tree was
    ...
    here().join("../../crates/driver-cuda/tests/hf_config_dump")
}
