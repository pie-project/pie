...
use crate::template::{
    ChatDecoder, GenericChatDecoder, Instruct, NoopReasoningDecoder, ReasoningDecoder,
    ThinkingDecoder, ToolDecoder, ToolEvent, ToolGrammar,
};
...
pub fn instruct(tokenizer: Arc<Tokenizer>) -> Arc<dyn Instruct> {
    Arc::new(GlmInstruct::new(tokenizer, GLM_CHATML))
}

pub struct GlmInstruct {
...
impl ToolDecoder for GlmToolDecoder {
