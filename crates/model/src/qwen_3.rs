...
pub const IMPORTS: &[crate::ImportRow] = &[
    ("qwen35-a3b-bf16-kv-bf16", |src| {
        Model::a3b(Dtype::Bf16, Dtype::Bf16, Dtype::Bf16, 1).import(src)
    }),
    ("qwen35-d3b-bf16-kv-bf16", |src| {
        Model::d3b(Dtype::Bf16, Dtype::Bf16, Dtype::Bf16, 1).import(src)
    }),
    ("qwen35-d0.8b-bf16-kv-bf16", |src| {
        Model::d0_8b(Dtype::Bf16, Dtype::Bf16, Dtype::Bf16, 1).import(src)
    }),
