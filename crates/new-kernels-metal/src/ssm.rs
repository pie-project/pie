...
pub fn causal_conv1d(
    ...
    ctx.fire(
        Fire::at("ssm/causal_conv1d.metal", entry).apply(conv_grid(channels, rows)),
        &[
            x.arg(),
            weight.arg(),
...
pub fn causal_conv1d_chunked(
    ...
    ctx.fire(
        Fire::at("ssm/causal_conv1d.metal", entry).apply(conv_grid(channels, lanes)),
        &[
            x.data.arg(),
            x.indptr.arg(),
            weight.arg(),
...
pub fn gdn_prep(
    ...
    ctx.fire(
        Fire::at("ssm/gdn_prep.metal", entry)
...
pub fn gated_delta(
    ...
    ctx.fire(
        Fire::at("ssm/gated_delta.metal", entry).apply(recurrence_grid(shape.v_heads, rows)),
        &[
            qkv.arg(),
            gates.arg(),
            state.state.arg_mut(),
...
pub fn gated_delta_chunked(
    ...
    ctx.fire(
        Fire::at("ssm/gated_delta.metal", entry).apply(recurrence_grid(shape.v_heads, lanes)),
        &[
            qkv.data.arg(),
            qkv.indptr.arg(),
            gates.arg(),
...
pub fn kda_step(
    ...
    ctx.fire(
        Fire::at("ssm/kda.metal", entry).apply(recurrence_grid(shape.heads, rows)),
        &[
            mixed.arg(),
            f.arg(),
            b.arg(),
...
pub fn kda_chunked(
    ...
    ctx.fire(
        Fire::at("ssm/kda.metal", entry).apply(recurrence_grid(shape.heads, lanes)),
        &[
            mixed.data.arg(),
            mixed.indptr.arg(),
            f.arg(),
