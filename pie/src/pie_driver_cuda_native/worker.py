...
def _write_startup_toml(
    *,
    ...
    # Per-device shmem name to match the runtime's
    # `/pie_shmem_g{device_idx}` convention (runtime/src/device.rs).
    # Each DP replica owns its own region; sharing a single `/pie_shmem`
    # was silently racy.
    device_idx = 0
    if device.startswith("cuda:"):
        try:
            ...
            device_idx = 0
    shmem_name = f"/pie_shmem_g{device_idx}"
