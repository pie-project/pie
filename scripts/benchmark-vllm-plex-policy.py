...
def policy_facts(
    ...
    facts: dict[str, Any] = {
        ...
        "agentix_mode": "plas",
        "program_wait_ms": 10000 if favored else 0,
        "call_wait_ms": 0,
        "program_arrival": index,
        "call_arrival": index,
        "critical_path_service_us": 0 if favored else 1000,
        "queue_bounds_us": [1000, 3000, 7000, 15000],
        "queue_quanta_us": [1000, 2000, 4000, 8000, 16000],
        ...
        "predicted_agent_kv_token_time": 100 if favored else 1000,
        "predicted_input_tokens": 16,
        "predicted_output_tokens": 64 if favored else 256,
        ...
        "worker_id": "vllm",
        "segment_index": 0,
        "sequence_path": f"0/{index}",
        "precedence_ready_at": 0,
        "now_token_step": 0,
        "critical_path_depth": 10 if favored else 1,
        ...
        "beneficiary_steps": [1 if favored else 100],
        "cache_state": "gpu",
        "cpu_backup": True,
        ...
        "average_cost_per_new_token_fp": 1000 if favored else 1,
        ...
        "lpm_hit_tokens": 4096 if favored else 0,
        "warm_threshold_tokens": 32,
        "deprio_prefix_id": f"prefix-{index // 2}",
        "cluster_id": f"cluster-{index // 2}",
        "cluster_size": 2,
        "ancestor_score": 100 if favored else 1,
        "root_child_pending_count": 2,
        "ancestor_demands": [
            {"pending_count": 2 if favored else 0, "depth": 4}
        ],
        "adapter_hot": favored,
        ...
        "remaining_work_ms": 100 if favored else 1000,
        "deadline_ms": 1000,
