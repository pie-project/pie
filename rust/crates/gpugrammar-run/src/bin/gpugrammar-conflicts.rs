...
use gpugrammar_lex::lexicon::{DEFAULT_TERMINAL_BUDGET, extract_within};
use gpugrammar_lex::regular::analyze;
use gpugrammar_lr::cfg::{DEFAULT_PRODUCTION_BUDGET, flatten_within};
use gpugrammar_lr::tables::{build, build_canonical};
use rayon::prelude::*;
...
fn main() -> anyhow::Result<()> {
    ...
    let budget: usize = std::env::var("GPUGRAMMAR_CANONICAL_STATES")
        .ok()
