...
use engrain_lex::lexicon::{Lexicon, extract};
use engrain_lex::regular::analyze;
use engrain_lr::cfg::{Cfg, Symbol, flatten};
use engrain_lr::parser::Parse;
use engrain_lr::tables::{Tables, build};
...
fn terminal(lexicon: &Lexicon, name: &str) -> Symbol {
    ...
    Symbol::Terminal(engrain_lex::TerminalId(index as u32))
}
