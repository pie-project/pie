...
extern "C" __global__ void en_arena_readback(
    ...
    out[at + 0] = en::base_of(arena, grammar, en::B_GROUP_OFFSETS);
    out[at + 1] = en::base_of(arena, grammar, en::B_ACTION_OFFSETS);
    out[at + 2] = en::base_of(arena, grammar, en::B_GOTO_OFFSETS);
    ...
    int32_t action_base = en::base_of(arena, grammar, en::B_ACTION_OFFSETS);
    out[at + 5] = arena->action_offsets[action_base];
    int32_t goto_base = en::base_of(arena, grammar, en::B_GOTO_OFFSETS);
    out[at + 6] = arena->goto_offsets[goto_base];
    int32_t reading_base = en::base_of(arena, grammar, en::B_READING_OFFSETS);
