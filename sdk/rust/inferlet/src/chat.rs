...
//! [`assistant_call`], [`cue`], [`cue_without_thinking`], [`seal`],
//! [`stop_tokens`]) produce token sequences for the bound model's template; [`Decoder`] parses generated tokens back into visible
...
pub use crate::pie::inferlet::chat::{
    Decoder, Event, assistant, assistant_call, cue, cue_without_thinking, first_user, seal,
    stop_tokens, system, system_user, user,
};
