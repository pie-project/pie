...
runtime ABI contracts for non-direct portable paths (sliced fused tensors,
stacked MoE experts, GGUF quantized tensors), then removing C++ planner/executor
fallbacks once every claimed model family has full Rust storage-program
coverage.
