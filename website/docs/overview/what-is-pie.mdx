...
Each example runs end-to-end inside the engine, without client round trips or engine patches.
The [Examples](../guide/examples/overview) page lists more inferlets.


## What inference programming brings

Pie introduces inference programming as a programming model for LLM applications. The control loop runs next to the model, and the application sees the engine's primitives directly instead of through a request/response endpoint.
