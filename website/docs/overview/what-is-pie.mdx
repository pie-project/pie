...
The examples above run end-to-end inside the engine, without client round trips or engine patches.
This "inference programming" unlocks a few new opportunities:
