# @pie-project/language-python

The python language component of pie, as an npm package: one wasm, registered
with `@pie-project/server` on import.

```js
import { Server } from '@pie-project/server';
import '@pie-project/language-python';        // python inferlets run
