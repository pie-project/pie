...
/// `/scratch` blob (`Context::save`) then reopens it (`Context::open`) and
/// continues — the replay-snapshot facade over `wasi:filesystem` (alpha `5b388407`).
/// Exercises the prefill + snapshot replay round-trip end-to-end on the mock driver.
#[test]
