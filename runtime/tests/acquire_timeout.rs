//! #470: bounded KV-page acquisition.
//!
...
//! scheduler's restore queue. Before #470 that deferral had no timer of its
//! own: `context::reserve_working_pages` blocked on its response channel
