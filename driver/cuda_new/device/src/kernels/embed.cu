...
// Lifted from driver/cuda/src/kernels/embed.cu (basic variant). The only
// change is renaming the launcher launch_embed_bf16 → embed_bf16 and moving
// it into namespace pie_cuda_device::kernels. The vocab-shard variant is a
// separate entry point lifted when the sharded forward bodies land.
