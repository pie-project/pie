...
// Lifted verbatim from driver/cuda/src/kernels/altup.cu
// (altup_predict_kernel + altup_correct_kernel and their launchers). Both
// kernels are self-contained bf16 — no dependency on kv_cache.hpp/tensor.hpp.
// The unused <cstdio> include from the source is dropped.
