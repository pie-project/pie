...
int run_impl(int argc,
    ...
    // Hand caps to the host. Standalone executable's default callback
    // writes `READY <json>` to stdout (the Python wrapper greps for
    // `^READY `); library callers route the JSON wherever they want.
