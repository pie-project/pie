...
inline bool nucleus_library_region_valid(
    ...
    const auto& logits_type = stage.value_types[region.inputs[0]];
    const auto& top_p_type = stage.value_types[region.inputs[1]];
    const auto& state_type = stage.value_types[region.inputs[2]];
