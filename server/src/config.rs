...
pub struct CudaNativeDriverOptions {
    ...
    /// Disable CUDA graph capture/replay for cuda_native. This preserves the
    /// existing eager forward path for tensor-parallel deployments whose
    /// topology or collective sequence cannot be captured reliably.
