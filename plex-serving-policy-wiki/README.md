...
- Citation counts come from an exact OpenAlex record when available, otherwise
  an exact Crossref title/DOI record. Preprint and proceedings versions can
  split citations, so counts are signals, not authoritative totals.
...
|---|---:|---|---:|---|
| [Parrot](papers/parrot.md) | 2024 | arXiv preprint | 5 | `R+S`; good corpus, larger application contract. |
...
| [Continuum](papers/continuum.md) | 2026 | arXiv preprint / UC Berkeley technical report, revised 2026 | — | Existing direct replica. |
...
| [Helium](papers/helium.md) | 2026 | arXiv preprint, 2026 | — | Existing `S`; prefetch is optional/mechanical. |
| [Justitia](papers/justitia.md) | 2025 | arXiv preprint, 2025 | — | Direct `S+F`. |
| [ThunderAgent](papers/thunderagent.md) | 2026 | arXiv preprint, 2026 | 0 | `S+E+B+F`; strong coordinated case. |
| [Pythia](papers/pythia.md) | 2026 | arXiv preprint, 2026 | 0 | `R+S+E+P+F`; excellent composition, high effort. |
| [HexAGenT](papers/hexagent.md) | 2026 | arXiv preprint, 2026 | 0 | `R+S`; temporal-holdout candidate. |
| [Observation, Not Prediction / ConServe](papers/observation-not-prediction-conserve.md) | 2026 | arXiv preprint | 0 | Simple `R`; strong logical-request example. |
| [SMetric](papers/smetric.md) | 2026 | arXiv preprint, 2026 | 0 | `R+B`; highly relevant holdout. |
| [GoodServe](papers/goodserve.md) | 2026 | arXiv preprint, 2026 | 0 | `R+B+F`; prediction-heavy. |
| [KAIROS](papers/kairos.md) | 2026 | arXiv preprint, 2026 | 0 | `A+R+F`; DVFS is an optional host action. |
| [A Workflow-Aware Serving Layer for Agentic Applications (Dyserve)](papers/a-workflow-aware-serving-layer-for-agentic-applications-dyserve.md) | 2026 | arXiv preprint, 2026 | 0 | `A+R+F` only if service plans are legal route candidates. |
| [SAGA](papers/saga.md) | 2026 | arXiv preprint, 2026 | 0 | `R+S+E+B`; holdout until artifact/source maturity improves. |
...
| [FairServe](papers/fairserve.md) | 2024 | arXiv preprint, 2024 | — | Direct `A+S+F`. |
| [DLPM/D²LPM](papers/dlpm-d2lpm.md) | 2025 | arXiv preprint, 2025 | — | Direct `R+S+F`. |
| [Andes](papers/andes.md) | 2024 | arXiv preprint | 6 | `S+F`; client token pacer is outside PLEX. |
| [Sarathi-Serve](papers/sarathi-serve.md) | 2024 | OSDI 2024 | 15 | `S`; mechanics-heavy but useful baseline. |
| [Response Length Perception and Sequence Scheduling](papers/response-length-perception-and-sequence-scheduling.md) | 2023 | arXiv preprint | 9 | Direct `S`. |
| [S³](papers/s3.md) | 2023 | NeurIPS 2023 | 7 | Direct `S`; compare with LTR. |
| [Efficient LLM Scheduling by Learning to Rank](papers/efficient-llm-scheduling-by-learning-to-rank.md) | 2024 | arXiv preprint | 1 | Direct `S`; [code](https://github.com/hao-ai-lab/vllm-ltr). |
...
| [Chameleon](papers/chameleon.md) | 2025 | MICRO 2025 | 0 | `A+S+E`; strong LoRA case. |
| [PEEK](papers/peek.md) | 2026 | arXiv preprint | 0 | Direct coordinated `S+E`. |
| [LLM Query Scheduling with Prefix Reuse and Latency Constraints](papers/llm-query-scheduling-with-prefix-reuse-and-latency-constraints.md) | 2025 | NeurIPS 2025 | — | Direct `S`; theory-friendly baseline. |
| [FastSwitch](papers/fastswitch.md) | 2024 | arXiv preprint | 1 | `S+E/P`; mechanisms are significant. |
| [PolyServe](papers/polyserve.md) | 2025 | arXiv preprint, 2025 | — | `A+R+S`; autoscaling is control-plane scope. |
| [SuperInfer](papers/superinfer.md) | 2026 | MLSys 2026 | 0 | `S+E+P`; Superchip-specific mechanics. |
| [PASCAL](papers/pascal.md) | 2026 | HPCA 2026 | 0 | `S`; useful reasoning holdout. |
| [Fairness-Aware and Latency-Controllable Scheduling for Chunked-Prefill LLM Serving](papers/fairness-aware-and-latency-controllable-scheduling-for-chunked-prefill-llm-serving.md) | 2026 | arXiv preprint | 0 | `S+F`; recent holdout. |
| [Regulating Branch Parallelism in LLM Serving](papers/regulating-branch-parallelism-in-llm-serving.md) | 2026 | arXiv preprint | 0 | Boundary test for branch-level `A/S`. |
| [PARD](papers/pard.md) | 2026 | EuroSys 2026 | 0 | Important boundary test: mid-lifecycle drop is not cleanly `admit`-once. |
...
| [Intelligent Router for LLM Workloads](papers/intelligent-router-for-llm-workloads.md) | 2024 | arXiv preprint, 2024 | — | `R`; learned/predictive alternative. |
| [SkyWalker](papers/skywalker.md) | 2026 | EuroSys 2026 | — | `R`; network/cost facts required. |
| [RouteBalance](papers/routebalance.md) | 2026 | arXiv preprint | 0 | `R`; include only if model choice is in route scope. |
...
| [MemServe](papers/memserve.md) | 2024 | arXiv preprint | 2 | `R+E/P`; mechanics-heavy. |
| [P/D-Serve](papers/p-d-serve.md) | 2024 | arXiv preprint | 1 | `R`; corpus-only unless policy is isolated. |
| [DynaServe](papers/dynaserve.md) | 2025 | arXiv preprint | 0 | `R+B`; architecture-heavy. |
...
| [Aladdin](papers/aladdin.md) | 2024 | arXiv preprint, 2024 | 1 | `R`; control-plane corpus. |
| [DynamoLLM](papers/dynamollm.md) | 2024 | arXiv preprint, 2024 | — | `R+B`; control-plane corpus. |
| [AIBrix](papers/aibrix.md) | 2025 | AIBrix technical white paper, 2025 | — | Deployment seam/target, not one source policy. |
| [dLoRA](papers/dlora.md) | 2024 | OSDI 2024 | — | `R+B`; excellent LoRA stress case. |
| [CaraServe](papers/caraserve.md) | 2024 | arXiv preprint | 1 | Direct `R+S`; CPU assist is mechanism. |
| [POLAR](papers/polar.md) | 2026 | arXiv preprint | 0 | `R+E+F`; recent holdout. |
## Residency, cache admission, eviction, and prefetch

| Paper | Year | Venue / status | Citations | PLEX |
|---|---:|---|---:|---|
| [SGLang / RadixAttention](papers/sglang-radixattention.md) | 2024 | NeurIPS 2024 | 10 | Canonical `S+E`; public implementation. |
...
| [UniCache](papers/unicache.md) | 2026 | SIGMETRICS 2026 | 0 | Direct `E`; recent holdout. |
| [CachedAttention](papers/cachedattention.md) | 2024 | USENIX ATC 2024 | 1 | `E+P`; much of the contribution is storage mechanics. |
| [Pensieve](papers/pensieve.md) | 2025 | EuroSys 2025 | 12 | `E+P`; corpus/adapter stress. |
| [HCache](papers/hcache.md) | 2025 | EuroSys 2025 | 13 | `E+P`; action/mechanics-heavy. |
| [PRESERVE](papers/preserve.md) | 2025 | arXiv preprint | 0 | Optional `P`; corpus. |
...
| [Strata](papers/strata.md) | 2026 | OSDI 2026 | — | `E/P`; corpus. |
...
| [INFaaS](papers/infaas.md) | 2021 | USENIX ATC 2021 | — | Foundational related-work baseline; pre-LLM request/state model. |
...
| [MArk](papers/mark.md) | 2019 | USENIX ATC 2019 | — | Foundational related-work baseline; pre-LLM request/state model. |
