...
This work studies serving when one user-visible task spans multiple LLM calls, workflow nodes, or tool boundaries rather than one isolated request. Its central policy contribution is: Place one heavy initial prefill and pin the conversation tail.
...
Jianru Ding, Ryien Hosseini, Pouya Mahdi Gholami, Mingyuan Xiang, Henry Hoffmann. “Observation, Not Prediction: Conversation-Level Disaggregated Scheduling for Agentic Serving.” arXiv (Cornell University), 2026. https://arxiv.org/abs/2606.01839.
