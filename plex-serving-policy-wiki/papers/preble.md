...
| Reputation evidence | strong publication signal from a selective systems/ML venue (ICLR 2025); author affiliations include UC San Diego WukLab; a public implementation or artifact is linked. |
...
This work studies how requests or state should be placed across replicas, tiers, models, or heterogeneous resources. The proposed policy centers on prefix reuse versus load/eviction-cost routing. The reported evaluation context includes Long shared-prompt and prefix-reuse workloads, Distributed prompt-serving traces used by the Preble artifact.
